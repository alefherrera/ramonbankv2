...
<%-- 					<s:textfield name="dni"></s:textfield> --%>
				...
				<tr>
					<td>Interes:</td>
					<td>
					<s:textfield name="interes"></s:textfield>
				...
				<tr>
					<td>Fecha Alta:</td>
					<td>
					<s:textfield name="fecha"></s:textfield>
					<!--<input type="text" name="apellido" class="required" />-->
					</td>
				</tr>
				<tr>
					...
					<td>
					<s:textfield name="cantidad"></s:textfield>
					<!--<input type="text" name="apellido" class="required" />-->
					</td>
				</tr>
				<tr>
					<td>Monto:</td>
					<td>
					<s:textfield name="monto"></s:textfield>
					<!--<input type="text" name="apellido" class="required" />-->
					</td>
				</tr>
				<tr>
